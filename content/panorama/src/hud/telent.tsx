                ...
                <Panel style={{ width: '212px', height: '44px' }}>
                    <Panel style={{ width: '200px', height: '32px', marginLeft: '12px', marginTop: '12px' }}>
                        <Panel style={{ width: '200px', height: '29px', backgroundColor: 'rgba(51, 51, 51, 1)' }}>
                            <Label
                                text={$.Localize(`#DOTA_Tooltip_ability_${k}`)}
                                style={{
        ...
        return (
            <Panel style={props.style}>
                <Panel style={{ width: '212px', height: '44px' }}>
                    <Panel style={{ width: '200px', height: '32px', marginLeft: '12px', marginTop: '12px' }}>
                        <Panel
                            style={{ width: '200px', height: isSelected != 0 ? '32px' : '29px' }}
                            className={isSelected != 0 ? 'telentPanelBg1' : 'telentPanelBg2'}
                        >
                            <Label
                                text={$.Localize(`#DOTA_Tooltip_ability_${k}`)}
                                className="text"
                                style={{ align: 'center center', fontSize: '13px', textOverflow: 'shrink', textAlign: 'center' }}
                            />
                    ...
                    {isSelected != 0 && (
                        <Panel style={{ width: '24px', height: '24px' }} className="telentEllipseImg">
            ...
            <>
                {
                    ...
                    <TelentPanel lvl={3} k={'special_bonus_unique_clinkz_2'} isSelected={0} isLocked={false} style={{ marginTop: '200px', marginLeft: '260px' }} /> */}
                            <Label
                                text={'<b><i>N</i></b> 普通天赋'}
                                html={true}
                                className="telentPanelText"
                                style={{ color: '#B1C4D9', marginLeft: '42px', marginTop: '20px' }}
                            />
                            <Label
                                text={'<b><i>R</i></b> 稀有天赋'}
                                html={true}
                                className="telentPanelText"
                                style={{ color: '#4661EA', marginLeft: '42px', marginTop: '102px' }}
                            />
                            <Label
                                text={'<b><i>SR</i></b> 传说天赋'}
                                html={true}
                                className="telentPanelText"
                                style={{ color: '#D32DE6', marginLeft: '42px', marginTop: '184px' }}
                            />
                            <Label
                                text={'<b><i>SSR</i></b> 不朽天赋'}
                                html={true}
                                className="telentPanelText"
                                style={{ color: '#DEAA39', marginLeft: '42px', marginTop: '266px' }}
                            />
                        </Panel>
                        ...
                        <Panel
                            ...
                            style={{
                                ...
                                backgroundColor: true
                                    ? 'gradient( linear, 0% 0%, 0% 100%, from( #5A615Ecc ), to( #879695cc ) )'
                                    : 'gradient(linear, 0% 0%, 0% 100%, from(#5Aa15E), to(#87d695))',
                            }}
                        >
